...
function begin_play(){
	if(started)
	{
		alert("Game has already started. Please use the reset game button to start a new game.")
		return;
	}
	if (document.getElementById('player1_id').value == '' || document.getElementById('player2_id').value == '')
	{
		alert("Please input two names before starting the game.");
		return;
	}
	else
	{
		...
		started = true;
		var str = "X"
		document.getElementById("turn_info").innerHTML = "Turn is: " + str.bold();
	}
