...
function enableButton(letter, capital, number, length, match) {
    ...
    let mrSet = new Set();
    mrSet.add(letter.className);
    mrSet.add(length.className);
    mrSet.add(match.className);
    mrSet.add(number.className);
    mrSet.add(capital.className);
    var condition = (mrSet.has('valid') && mrSet.size == 1); // TODO: Replace false with the correct condition
