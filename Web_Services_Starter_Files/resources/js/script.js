...
$(document).ready(function() {
  var url = 'https://api.weatherstack.com/current?access_key=5bc82451636190abd9d7afe6fe9b20b5&query=boulder, colorado'; //Place your weatherstack API Call Here - access_key to be used: 5bc82451636190abd9d7afe6fe9b20b5
  $.ajax({url:url, dataType:"jsonp"}).then(function(data) {
    ...
    */
    ...
    document.getElementById('heading').innerHTML = "Today's Weather Forecast in " + data.location.name;
    document.getElementById('thermometer_inner').innerHTML = getFarenheitTemp(data.current.temperature) + ' F';
    ...
    */
    ...
    for(i = 0; i < 7; i++)
    {
      ...
      let father = document.getElementById('5_day_forecast');

      card.appendChild(header);
      styles.appendChild(card);
      father.appendChild(styles);
